...
find_path(GOBY_INCLUDE_DIR goby/version.h
  PATHS ${GOBY_ROOT_DIR} ${CMAKE_SOURCE_DIR}/../goby ${CMAKE_SOURCE_DIR}/../../goby ${CMAKE_SOURCE_DIR}/../.. 
...
message("Using Goby in ${GOBY_DIR} (Version ${GOBY_VERSION_MAJOR}.${GOBY_VERSION_MINOR})")
#
# Find libraries
# 
...
if(GOBY_VERSION_MAJOR GREATER "1")
  ...
  find_goby_library(GOBY_PB_LIBRARY goby_pb ${GOBY_DIR})
